...
if(!empty($_POST["send"])){
  $name=$_POST['name'];
	...
	$mobile=$_POST['phone'];
	$gender=$_POST['gender'];
  $toEmail= $_POST["vartakdipanshu@gmail.com"];
$mailHeaders = "Name: " . $name .
"r\n\ Email: " .$email. "\r\n";

if(mail($toEmail,$name)){
  $message ="aaaaaaaaaaaaa gyaaaaaaaaaaaaaaaaaaa";
}
}
?>
...

{
	...
	if($num>1)
	{
  echo "<script>alert('Email-id already register with us. Please try with different email id.');</script>";
...
<meta charset="utf-8" />
<title>CodingThumbs-CRM | Registration</title>
...
<div class="container">
  <div class="row login-container column-seperation">  
        <div class="col-md-5 col-md-offset-1">
          <h2>Sign in to CodingThumbs-CRM</h2>
          <p>            <a href="login.php">Sign in Now!</a> It's free and always will be..</p>
          <br>
